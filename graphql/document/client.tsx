import { RefreshResponse, RefreshTokenDocument } from '../generated/index';
import { Platform, clearLocalStorage, getRefreshToken, getToken, setToken } from '@/lib';
import {
  ApolloClient,
  ApolloLink,
  FetchResult,
...
const httpLink = new HttpLink({
	uri: process.env.NEXT_PUBLIC_CAMILLE_SERVER_URL,
});
...
export const client = new ApolloClient({
	...
	connectToDevTools: !process.env.VITE_NODE_ENV,
});
